...
namespace TeorVerBalls2
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (images1[n1].Tag == "white" & images2[n2].Tag == "white")
            {
                ww++;
                label1.Text = "Белый белый: " + ww;
            }
            else if (images1[n1].Tag == "white" & images2[n2].Tag == "black" | images1[n1].Tag == "black" & images2[n2].Tag == "white")
            {
                wb++;
                label2.Text = "Белый черный: " + wb; 
            }
            else if (images1[n1].Tag == "black" & images2[n2].Tag == "black")
            {
                bb++;
